      ...
      <section class="tm-header-a uk-grid" data-uk-grid-match="{target:'> div > .uk-panel'}">
        <div class="uk-width-1-1">
          <div class="uk-panel">
            ...
            <!-- slideshow -->
            <div class="tm-slideshow-gaucho tm-full-slideshow uk-slidenav-position" data-uk-slideshow="{autoplay:true, animation: 'scale', pauseOnHover: true, duration: 750, autoplayInterval: 15000, kenburns: true, kenburnsanimations: 'uk-animation-top-center'}">
        ...
        <div class="uk-width-1-1">
          <div class="uk-panel uk-text-center">
            ...
            <div data-uk-scrollspy="{cls:'uk-animation-slide-bottom', delay:1600}">
              <a class="uk-button-primary uk-button-large uk-margin-top uk-button" href="?page=menu" target="_self">See the Menu</a>
            </div>
          </div>
        </div>
      </section>
