            ...
            <article class="uk-article tm-article">
              <div class="tm-article-wrapper">
                <div class="tm-article-content uk-margin-large-bottom uk-margin-top-remove">
                  ...
                  <div id="script-warning" class="uk-badge uk-badge-danger uk-margin-large-bottom">
                      <strong>php/get-events.php</strong> must be running.
                    </div>
                    ...
                    <p>The events calendar can be used to display calendar events which are loaded from a JSON file. You can learn more about Fullcalendar component <a href="http://fullcalendar.io/docs/" target="_blank">here</a></p>
